...
public class UtilisateursManager {
	...
	public void insertUtilisateur(String pseudo, String nom, String prenom, String email, String telephone, String rue, String code_postal,String ville,String mdp, String verif_mdp) {
		...
		if(this.validerUtil(pseudo, nom, prenom, email, telephone, rue, code_postal, ville, mdp, verif_mdp)) {
			try {
				Utilisateurs util = new Utilisateurs(pseudo, nom, prenom, email, telephone, rue, code_postal, ville, mdp, 0, false);
	...
	private boolean validerUtil(String pseudo, String nom, String prenom, String email, String telephone, String rue, String code_postal,String ville,String mdp, String verif_mdp) {
		Boolean valide = true;
		//TODO pour tous les champs autre que mdp et pseudo, tester si il n'y a pas des caractères spéciaux
