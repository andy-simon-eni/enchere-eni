...
public class UtilisateursManager {
	...
	public Utilisateurs insertUtilisateur(String pseudo, String nom, String prenom, String email, String telephone, String rue,
		...
		if (!businessException.hasErreurs()) {
			 ...
			 util = new Utilisateurs(pseudo, nom, prenom, email, telephone, rue, code_postal, ville, mdp, 0,
					false);
	...
	private void validerUtil(String pseudo, String nom, String prenom, String email, String telephone, String rue,
		...
		if (pseudo == null || pseudo.isEmpty() || pseudo.length() > 30 || !patternCompile_Pseudo.matcher(pseudo).matches()) {
		...
		if (nom == null || nom.isEmpty() || nom.length() > 30 || !patternCompile_Nom_Prenom_Ville.matcher(nom).matches()) {
			businessException.ajouterErreur(CodesResultatBLL.REGLE_UTIL_NOM_INVALIDE);
		}
		if (prenom == null || prenom.isEmpty() || prenom.length() > 30 || !patternCompile_Nom_Prenom_Ville.matcher(prenom).matches()) {
		...
		if (ville == null || ville.isEmpty() || ville.length() > 30 || !patternCompile_Nom_Prenom_Ville.matcher(ville).matches()) {
