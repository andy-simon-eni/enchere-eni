 ...
 */
@WebServlet(urlPatterns = { "/creation_enchere" })
public class creationEnchereServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			articlesManager.insertArticleVendu(nomArticle, description, dateDebut, dateFin, prixInitial,
					(int) session.getAttribute("id"), noCateg, rue, codePostal, ville);
		} catch (BusinessException e) {
			valide = false;
